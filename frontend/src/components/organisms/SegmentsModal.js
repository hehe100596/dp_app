...
export function SegmentsModal({ segmentId, moduleId, type, closeModal }) {
  // TODO: Add test and other segment types!
  ...
  // TODO: Replace textarea for data with HTML WYSIWIG editor!
  return (
    <Modal
    ...
    >
      <div align="center">
        <EmptyLine level="2" />
        <Heading level="2">
          {segmentId === "new" ? "ADD SEGMENT" : "EDIT SEGMENT"}
        </Heading>
        <EmptyLine level="2" />
        <Formik
          initialValues={{
